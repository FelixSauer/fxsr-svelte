	...
	onMount(async () => {
      ...
      console.log(
        'Hallo'
			...
			template = (await import('../contact/Contact.svelte')).default;
		} else if (page.name === 'imprint') {
			template = (await import('../imprint/Imprint.svelte')).default;
		}
	});
</script>

<svelte:component this={template} {page} />
